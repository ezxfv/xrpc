...
func _Chord_Join_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor types.UnaryServerInterceptor) (interface{}, error) {
	var ins []interface{}
	var (
...
func _Chord_Leave_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor types.UnaryServerInterceptor) (interface{}, error) {
	var ins []interface{}
	var (
		xctx = xrpc.XBackground()
		in_1 = new(Message)
...
func _Chord_Lookup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor types.UnaryServerInterceptor) (interface{}, error) {
	var ins []interface{}
	var (
		xctx = xrpc.XBackground()
		in_1 = new(Message)
...
func _Chord_FindSuccessor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor types.UnaryServerInterceptor) (interface{}, error) {
	var ins []interface{}
	var (
		xctx = xrpc.XBackground()
		in_1 = new(Message)
...
func _Chord_Notify_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor types.UnaryServerInterceptor) (interface{}, error) {
	var ins []interface{}
	var (
		xctx = xrpc.XBackground()
		in_1 = new(Message)
...
func _Chord_HeartBeat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor types.UnaryServerInterceptor) (interface{}, error) {
	var ins []interface{}
	var (
		xctx = xrpc.XBackground()
		in_1 = new(Message)
...
func _Chord_Set_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor types.UnaryServerInterceptor) (interface{}, error) {
	var ins []interface{}
	var (
		xctx = xrpc.XBackground()
		in_1 = new(Message)
...
func _Chord_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor types.UnaryServerInterceptor) (interface{}, error) {
	var ins []interface{}
	var (
		xctx = xrpc.XBackground()
		in_1 = new(Message)
...
func _Chord_Del_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor types.UnaryServerInterceptor) (interface{}, error) {
	var ins []interface{}
	var (
		xctx = xrpc.XBackground()
		in_1 = new(Message)
...
var _Chord_serviceDesc = types.ServiceDesc{
