// Copy from echo.v4 "github.com/labstack/echo/v4"
package echo
...
type Context interface {
	...
	// PathParam returns a path param
	PathParam(key string) (param string)
...
func (c *context) PathParam(key string) (param string) {
...
func (c *context) Render(code int, name string, data interface{}) (err error) {
	if c.echo.render == nil {
		return ErrRendererNotRegistered
	}
	buf := new(bytes.Buffer)
	if err = c.echo.render.Render(buf, name, data, c); err != nil {
		return
	}
