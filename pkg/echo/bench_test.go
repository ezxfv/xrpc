...
func init() {
	...
	calcMem("EchoRouter", func() {
		echoRouter = echo.New()
		handler := func(c echo.Context) error {
			return c.String(204, "")
		}
		for _, route := range githubAPI {
			echoRouter.HandleFunc(route.path, handler, route.method)
		}
	})
...
//  34670	     31807 ns/op	   13792 B/op	     167 allocs/op
func BenchmarkHttpRouterWithGithubAPI(b *testing.B) {
	benchRoutes(b, httpRouter, githubAPI)
}

// 1880	    587564 ns/op	  417369 B/op	    4872 allocs/op
func BenchmarkEchoRouterWithGithubAPI(b *testing.B) {
	benchRoutes(b, echoRouter, githubAPI)
}

// 1622	    720673 ns/op	  515453 B/op	    5983 allocs/op
func BenchmarkEchoRouterWithGithubAPI2(b *testing.B) {
	benchRoutes(b, echoRouter, githubAPI2)
}
