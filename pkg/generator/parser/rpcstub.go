...
func RpcStub(meta *MetaData, b StubBuilder, w io.Writer) error {
	...
	meta.AddPkg(&Pkg{
		Alias: "",
		Path:  "x.io/xrpc/types",
	})
	meta.AddStubPkg("types")
	b.Gen(meta, gen)
	stubPkgs := meta.StubPkgs()
	if EnableHeader {
		wb.Write([]byte(fmt.Sprintf(`// Code generated by xrpc. DO NOT EDIT.
...
type StubBuilder interface {
	Gen(meta *MetaData, gen *Generator) error
}
...
func (b *xrpcStubBuilder) Gen(meta *MetaData, gen *Generator) error {
	err := b.serverStub(meta, gen)
	if err != nil {
		return err
	}
	err = b.clientStub(meta, gen)
	return err
}
